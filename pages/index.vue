<template>
  <div class="flex flex-col min-h-screen">
    ...
    <div class="flex-1 bg-gray-100 flex justify-center p-2">
      ...
      <div v-else class="self-center text-xs font-semibold">
        No posts found, follow more people to discover their post!
      </div>
    </div>

    <Menu
      :avatar="getAuthUser.avatar"
      @toggleAddPostx="() => (addPost = true)"
    />
